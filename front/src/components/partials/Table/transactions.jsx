      ...
      return (
        <div>
          <span className="inline-flex items-center">
            <span className="w-7 h-7 rounded-full ltr:mr-3 rtl:ml-3 flex-none bg-gray-600">
              <img
    ...
    Cell: (row) => {
      return (
        <span className="block w-full">
          <span
            className={`${row?.cell?.value === "paid" ? "text-green-600 " : ""} 
            ${row?.cell?.value === "due" ? "text-yellow-400 " : ""}
            ${row?.cell?.value === "cancled" ? "text-red-600" : ""}
