...
const description = Yup.string()
  .max(4096, "توضیحات نمی تواند بیشتر از 4096 کاراکتر باشد")
  .nullable();

const gateway = Yup.string()
  .oneOf(paymentGatewayItems, "نوع درگاه پرداخت مجاز نیست")
  .required("نوع درگاه پرداخت الزامی است");
...
// Register User
exports.registerUserValidation = Yup.object().shape({
  firstName,
  lastName,
  fatherName,
  unionName,
...
// Login User
exports.loginUserValidation = Yup.object().shape({
  phoneNumber,
  password,
});
...
// Edit User
exports.editUserValidation = Yup.object().shape({
  avatar,
  firstName,
  lastName,
  fatherName,
...
// Change Password
exports.changePasswordValidation = Yup.object().shape({
  password,
  newPassword,
...
exports.createUserForAdminValidation = Yup.object({
  avatar,
  firstName,
  lastName,
  fatherName,
...
// Edit User For Admin
exports.editUserForAdminValidation = Yup.object({
  avatar,
  firstName,
  lastName,
  fatherName,
...
exports.changeUserPasswordForAdminValidation = Yup.object().shape({
  password,
  confirmPassword,
});

// Edit Setting
exports.editSettingValidation = Yup.object().shape({
  paymentGateway,
});
